...
# Quiet noisy third-party loggers so the console shows only meaningful app logs.
# (SQL echo is already off; these stop per-request HTTP/connection chatter.)
for _noisy in (
    "httpx",
    "httpcore",
    "sqlalchemy.engine",
    ...
    "uvicorn.access",
    "asyncio",
    "watchfiles",  # uvicorn --reload file watcher
    "watchfiles.main",
